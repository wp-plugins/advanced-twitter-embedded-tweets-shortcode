...
add_shortcode('embedTweet', 'advancedTwitterEmbeddedTweetsShortcode');
 function advancedTwitterEmbeddedTweetsShortcode($atts){
 	...
 	extract($atts);
        ...
        $data .= $html;
		if($author == "true"){
			$data .= "<div style='font-size: 9px; color: #808080; font-weight: normal; font-family: tahoma,verdana,arial,sans-serif; line-height: 1.28; text-align: right; direction: ltr;'><a href='http://www.backpainfreeme.com/' target='_blank' style='color: #808080;' title='LaGrange West GA Back Pain Clinic'>Homepage</a></div>";}
    return $data;
 }